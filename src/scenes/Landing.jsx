      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          ...
          >
            <img
              alt="profile"
              className="hover:filter hover:saturate-200 transition duration-500 z-10 w-[200px] md:w-[300px] h-auto rounded-t-full"
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <p className="text-6xl font-playfair z-10 text-center md:text-start">
            ...
            <span
              ...
              before:absolute before:-left-[20px] before:-top-[90px] before:z-[-1]"
            >
              Manukyan
            </span>
            <br />
        ...
        >
          ...
          <AnchorLink
            ...
            href="#contact"
          >
            <div className="bg-slate-200 hover:text-red transition duration-500 w-full h-full flex items-center justify-center px-10 font-playfair">
              Let's talk.
            </div>
          </AnchorLink>
        </motion.div>
